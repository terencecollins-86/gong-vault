...
Full pattern + rules: [[Work/Architecture/Troubleshoot Endpoints]]. Swagger discovery:
[[Work/Engineering/Swagger Pages]].
...
- **Runtime log levels:** adjustable via Logs Manager (no redeploy) — [[Work/Engineering/Swagger Pages]].
