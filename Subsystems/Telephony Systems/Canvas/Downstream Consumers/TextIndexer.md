...
> [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Telephony Systems - External Data Flow.canvas|← Data-flow canvas]] · [[06 - Runbook & Troubleshooting|Runbook]] · [[05 - Observability|Observability]] · Owner: **dor.shemer@gong.io**
...
| **Consumes** | `texts-ingested` (see [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Outbound Topics/TEXTS-INGESTED]]) |
...
Discover exact live paths via Swagger: `https://textindexer-vip.prod.gongio.net/swagger-ui/index.html` (VPN + `troubleshootersAuthJWT` cookie). See [[Work/Architecture/Troubleshoot Endpoints]].
...
> Related: [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Core/IngesterTelephonySystemsSupervisor]] · [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Outbound Topics/TEXTS-INGESTED]]
