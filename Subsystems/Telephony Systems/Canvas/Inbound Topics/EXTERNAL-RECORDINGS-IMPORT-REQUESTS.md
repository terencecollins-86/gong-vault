...
Swagger (RecordingsImporter): `https://<recordingsimporter>-vip.prod.gongio.net/swagger-ui/index.html` (VPN + `troubleshootersAuthJWT` cookie). See [[06 - Runbook & Troubleshooting|Runbook]] §4 and [[Work/Architecture/Troubleshoot Endpoints]].
