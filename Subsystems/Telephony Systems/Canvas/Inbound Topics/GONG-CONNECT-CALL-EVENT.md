...
|---|---|
| "Gong Connect calls missing" reported against this topic | It can't be the cause — handler is a no-op (`:27`). Chase [[Subsystems/Consent/Canvas 1/Telephony Systems/Inbound Topics/GONG-CONNECT-DIALER-EVENTS]] (the real push path) and the sync chain instead. |
