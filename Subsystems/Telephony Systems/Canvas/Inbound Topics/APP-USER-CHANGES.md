...
Base path `/troubleshooting/ms-teams-numonix` (`MSTeamsNumonixTroubleshooter.java:59`). Swagger: `https://ingestertelephonysystemssupervisor-vip.prod.gongio.net/swagger-ui/index.html` (VPN + `troubleshootersAuthJWT` cookie). See [[Work/Architecture/Troubleshoot Endpoints]].
