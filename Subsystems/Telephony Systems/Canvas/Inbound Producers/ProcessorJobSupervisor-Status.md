...
To exercise the **outbound** hand-off this loop reports on, drive an ingest via `process-one-event` / `syncOneCall` (see [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Outbound Topics/CALL-PROCESSING-INBOUND]] and [[Entrypoints Within the Telephony System]] §2/§3).
...
> Related: [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Core/IngesterTelephonySystemsSupervisor]] · [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Inbound Topics/CALL-PROCESSING-STATUS-EVENT]] · [[Subsystems/Call Scheduling/Canvas/Telephony Systems/Outbound Topics/CALL-PROCESSING-INBOUND]] · [[Entrypoints Within the Telephony System]]
