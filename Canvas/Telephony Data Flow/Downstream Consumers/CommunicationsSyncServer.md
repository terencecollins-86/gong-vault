...
| **Consumes** | `dialer-calls-updates` (see [[DIALER-CALLS-UPDATES]]) **+** `webconference-call-events` (see [[WEBCONFERENCE-CALL-EVENTS]]) |
...
> Related: [[IngesterTelephonySystemsSupervisor]] · [[DIALER-CALLS-UPDATES]] · [[WEBCONFERENCE-CALL-EVENTS]]
