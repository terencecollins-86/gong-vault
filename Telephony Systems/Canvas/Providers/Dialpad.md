...
| **Downstream** | shared `processCallEvent` (push) / sync→ingest path → [[Call Scheduling/Canvas/Telephony Systems/Outbound Topics/DIALER-CALLS-UPDATES]] |
...
Webhook subscription/management endpoints are documented separately — [[Call Scheduling/Canvas/Telephony Systems/Web - REST/Dialpad-Webhook-Controller]]. Discover live paths via Swagger: `https://ingestertelephonysystemssupervisor-vip.prod.gongio.net/swagger-ui/index.html` (VPN + `troubleshootersAuthJWT` cookie). See [[Architecture/Troubleshoot Endpoints]].
...
| Webhook events not arriving | Not this page — check the subscription/callback side: [[Call Scheduling/Canvas/Telephony Systems/Web - REST/Dialpad-Webhook-Controller]]. |

Related: [[Call Scheduling/Canvas/Telephony Systems/Core/IngesterTelephonySystemsSupervisor]] · [[Call Scheduling/Canvas/Telephony Systems/Web - REST/Dialpad-Webhook-Controller]] · [[Call Scheduling/Canvas/Telephony Systems/Inbound Topics/GONG-CONNECT-DIALER-EVENTS]] · [[Call Scheduling/Canvas/Telephony Systems/Outbound Topics/DIALER-CALLS-UPDATES]] · [[04 - Providers & Dialers]] · [[Entrypoints Within the Telephony System]]
