...
| **Downstream** | [[Call Scheduling/Canvas/Telephony Systems/Downstream Consumers/TextIndexer]] → `TextIngestedConsumer.accept` → `textIndexerService.indexMessages` |
