...
| **Downstream** | Same as main path: ingest → `dialer-calls-updates` ([[Call Scheduling/Canvas/Telephony Systems/Outbound Topics/CALL-PROCESSING-INBOUND]]) |
