...
> Other Gong services (including [[Calendar Ingestion/_dashboard|Calendar Ingestion]]) *connect to* a
> `RECORDING_CONSENT` logical DB — see the calendar [[Calendar Ingestion/Storage & Schema Reference]],
...
- [[00 - Overview]]
- [[01 - Services & Modules]]
- [[Calendar Ingestion/Storage & Schema Reference]] — lists the `RECORDING_CONSENT` connection from the calendar side
