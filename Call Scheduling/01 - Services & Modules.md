...
[[Calendar Ingestion/_dashboard|Calendar Ingestion]].

| Class | Role |
|---|---|
| **`IngesterCalendarSupervisor`** | Orchestrates calendar sync fan-out (see [[Calendar Ingestion/03 - Services Reference]]). |
...
- [[00 - Overview]]
- [[Consent/_dashboard|Consent]] — resolution changes trigger cancellation
- [[Calendar Ingestion/02 - Data Flows]]
