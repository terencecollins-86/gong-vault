...
> **Calendar ingestion** ([[Calendar Ingestion/_dashboard|Calendar Ingestion]]) fans out per-user
...
[[Consent/_dashboard|recording consent]]. Scheduling uses
...
- Upstream feeder: [[Calendar Ingestion/_dashboard|Calendar Ingestion]]
- Consent gating: [[Consent/_dashboard|Consent]]
